...
* If you already have a Linux VPS, you can run extension node 
* Or you can buy a cheap server for $5/m from- Note that you can install Windows on these servers
...
* Open Extension, Signup with your email and use invite code: ``
...
* Use invite code to get boost: `p8y7l`
...
### 3DOS
* Register [Dashboard](https://dashboard.3dos.ioregister?ref_code=23e7ec)
